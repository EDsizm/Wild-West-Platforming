...
var clouds = [{x_pos: 30, y_pos: 80, size: 1, speed : 1},
              {x_pos: 800, y_pos: 100, size: 1.2, speed : 2},
              {x_pos: 420, y_pos: 50, size: 0.8, speed : 1.5},
              {x_pos: 120, y_pos: 150, size: 0.6, speed : 2},
              {x_pos: 220, y_pos: 150, size: 1.1, speed : 2.7}];

var mountains = [{x_pos: 468, y_pos: 222, size: 1},
                 {x_pos: 800, y_pos: 180, size: 1.2},
                 {x_pos: -110, y_pos: 86, size: 1.65},
                 {x_pos: -1350, y_pos: 160, size: 1.2}];
...
var collectables = [{x_pos: 100, y_pos: 400, size: 1, isFound : false, isCounted : false},
                    {x_pos: 800, y_pos: 350, size: 1, isFound : false, isCounted : false},
                    {x_pos: -400, y_pos: 300, size: 1, isFound : false, isCounted : false},
                    {x_pos: -900, y_pos: 400, size: 1, isFound : false, isCounted : false},
                    {x_pos: -2240, y_pos: 200, size: 1, isFound : false, isCounted : false}]

var canyons = [{x_pos: 650, y_pos : 432, width_c: 0.8},
               {x_pos: 1010, y_pos : 432, width_c: 1.4},
               {x_pos: -750, y_pos : 432, width_c: 1.7},
               {x_pos: -350, y_pos : 432, width_c: 0.8},
               {x_pos: -1120, y_pos : 432, width_c: 1.2},
               {x_pos: -4000, y_pos : 432, width_c: 23}];
...
var flag_pole = {x_pos : 1500, y_pos : 122, isReached : false, golePoint : 1400, startCutscene : false};
